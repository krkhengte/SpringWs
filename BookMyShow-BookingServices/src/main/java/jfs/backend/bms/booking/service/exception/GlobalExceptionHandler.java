...
import jfs.backend.bms.booking.service.payload.ApiResponse;
...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(SeatLimitExtends.class)
	public ResponseEntity<ApiResponse> seatLimitExtends(SeatLimitExtends ex) {
